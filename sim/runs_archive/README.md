...
현재 활성 학습은 [`../runs/m4_cpg_v1/`](../runs/m4_cpg_v1) · [`../runs/m4_cpg_v2/`](../runs/m4_cpg_v2) (`<card>/seed{0,1,2}/<stage>/model.zip` 구조). 이 디렉토리는 옛 학습의 `model.zip`·`SAC_1/`·log를 보존만 함 (curriculum chain에서 참조되지 않음).
...
> 옛 분류 `m1_m3_multi_seed/` (v24~v33) · `mode3_planar/` 는 GitHub release 백업이 있어 2026-05-27 로컬 삭제됨.
